                ...
                <div className="relative">
                  ...
                  {isMenuOpen && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 py-2 transition-all duration-200 scale-95 group-hover:scale-100 origin-top-right" role="menu">
                      <Link to="/dashboard/bookings" className="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 flex items-center gap-2" role="menuitem">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={ICONS.DASHBOARD} /></svg>
                        Dashboard
                      </Link>
                      <a
                        href="https://pro.thelokals.com"
