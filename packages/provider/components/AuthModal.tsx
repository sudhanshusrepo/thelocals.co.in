                    ...
                    {success ? (
                        ...
                        <div>
                            <div className="text-center mb-8">
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{isLogin ? 'Provider Sign In' : 'Become a Partner'}</h2>
                                <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">
                                    {isLogin ? 'Enter your details to access your dashboard' : 'Join as a service provider and grow your business'}
                                </p>
                            </div>
